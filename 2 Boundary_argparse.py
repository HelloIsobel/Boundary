...
def get_maxContour(bw):
    ...
    if len(contours) != 0:
        ...
        if contours_area[int(max_area_index)] > args.T_contour_area:  # TODO： 尺寸未减半时是30000
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dirpath", type=str, metavar="", default="data/result/test0301/", help="Save images")
